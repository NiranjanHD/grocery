...
<div id="content_01">
		...
		<div id="content_02_text"><h1><b><em><marquee>THIS USER NAME ALREADY EXIST PLEASE TRY ANOTHER....!</marquee></em></b></h1>
  		
    	
	    </div>
			<tr>
               	<td colspan="2" align="center" style="color:#CC0000;font-size:18px"></td><br>
			<td align="center"><font color="#CCCC00" size="+1"><p>please signup again</p><a href="signup.jsp">Sign up</a></font></td>
