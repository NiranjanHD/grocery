...
//alert("jj"+jj);
	...
	document.getElementById(j1).value=v2;
...
<input type="hidden" name="qt" id="qt">
 ...
 <%
        Connection dbcon=null;String a = null,a1=null,b=null,c=null,d=null,j=null,j1=null;
        try
	    {  
		String connectionURL = "jdbc:mysql://localhost/grocery";
              		String Qry="select *from items where category='Grains'";
...
j1=rs.getString(8);
		...
		<td width="5%" align=left><font color="#666666"><b><input type="text" id="<%=c%>" onchange="g('<%=b%>','<%=c%>','<%=d%>','<%=a1%>','<%=j%>','<%=j1%>')"/>
