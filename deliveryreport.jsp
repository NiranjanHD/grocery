...
<div id="content_01">
        ...
        <td><div id="content_01_image">
                    <div id="page_name">Delvry Rpt</div>
            </div>
 ...
 <table width="880">
  ...
  <li><a href="deliveryreport.jsp">Delivery reports</a></li>
   <li><a href="undeliverreport.jsp">Undelivery reports</a></li>
    	...
    	<br>
 <h1><b><em>Reports details of Delivery</em></b></h1><br><br>
		...
		<input type="hidden" name="e">
		  ...
		  <TR>
			...
			<TABLE cellSpacing=3 cellPadding=2 width="100%" border=00>
			 ...
			 <%
					...
					String connectionURL = "jdbc:mysql://localhost/grocery";
								String Qry="select *from purchase where flag='1'";
			 ...
			 %>
					...
					<tr height="20%">
					 <td width="5%" > <font color="black"  face="times new roman" size=3><b>BILLNO</b></font></td>
					<td  width="5%" ><font color="black"  face="times new roman" size=3><b> UID</b></font></td>
					<td  width="5%" ><font color="black"  face="times new roman" size=3><b> ADDRESS</b></font></td>
					<td  width="5%" ><font color="black"  face="times new roman" size=3><b> MOP</b></font></td>
					<td width="5%" > <font color="black"  face="times new roman" size=3><b>PNAME</b></font></td>
					
					<td width="5%" > <font color="black"  face="times new roman" size=3><b>PQTY</b></font></td>
					
					<td  width="5%" ><font color="black"  face="times new roman" size=3><b>OAMT</b></font></td> 
					<td  width="5%" ><font color="black"  face="times new roman" size=3><b>QAMT</b></font></td> 
        	...
        	%>
				...
				<tr height="30%">	
				<td width="5%" align=left><font color="#666666"><b><input type="hidden" name="r1" size="<%=a%>"><%out.print(a);%></b></font></td>
				<td width="5%" align=left><font color="#666666"><b><%=rs.getString(2)%></b></font></td>
				<td width="5%" align=left><font color="#666666"><b><%=rs.getString(4)%></b></font></td>
				<td width="5%" align=left><font color="#666666"><b><%=rs.getString(5)%></b></font></td>
				<td width="5%" align=left><font color="#666666"><b><%=rs.getString(6)%></b></font></td>
				<td width="5%" align=left><font color="#666666"><b><%=rs.getString(7)%></b></font></td>
				<td width="5%" align=left><font color="#666666"><b><%=rs.getString(8)%></b></font></td>
				<td width="5%" align=left><font color="#666666"><b><%=rs.getString(9)%></b></font></td>
...
var r=confirm("Do you want to update this Record");
	if(r==true)
	{
		...
		document.trl.action="updetails.jsp";
		document.trl.submit();
	}
	else
	{
