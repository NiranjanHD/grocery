...
<div id="content_01">
        ...
        <td><div id="content_01_image">
                    <div id="page_name">Offers Rpt</div>
            </div>
...
<div id="content_vertical">
 ...
 <h1><b><em>	Reports details of Offers</em></b></h1><br><br>
...
%>
        ...
        <tr height="20%">
		 <td width="5%" > <font color="black"  face="times new roman" size=3><b>QTY</b></font></td>
 		 <td width="5%" ><font color="black"  face="times new roman" size=3><b>AMT</b></font></td>
...
a = rs.getString(1);
        %>
         ...
         <tr height="30%">	
        		<td width="5%" align=left><font color="#666666"><b><%out.print(a);%></b></font></td>
...
var r=confirm("Do you want to Delete this Record Permanently");
	if(r==true)
	{
		...
		document.trl.action="delavo.jsp";
		document.trl.submit();
	}
	else
	{
