		  ...
		  <TR>
			...
			<TABLE cellSpacing=3 cellPadding=2 width="100%" border=00>
			 ...
			 %>
					...
					<tr height="20%">
					 <td width="5%" > <font color="black"  face="times new roman" size=3><b>EID</b></font></td>
					<td  width="5%" ><font color="black"  face="times new roman" size=3><b> FNAME</b></font></td>
					<td  width="5%" ><font color="black"  face="times new roman" size=3><b> SNAME</b></font></td>
					<td  width="5%" ><font color="black"  face="times new roman" size=3><b> UNAME</b></font></td>
					<td width="5%" > <font color="black"  face="times new roman" size=3><b>PASSWORD</b></font></td>
					
					<td width="5%" > <font color="black"  face="times new roman" size=3><b>EMAIL</b></font></td>
					
					<td  width="5%" ><font color="black"  face="times new roman" size=3><b>DOB</b></font></td> 
					<td  width="5%" ><font color="black"  face="times new roman" size=3><b>GENDER</b></font></td> 
					<td  width="5%" ><font color="black"  face="times new roman" size=3><b>ADDRESS</b></font></td>
					<td  width="5%" ><font color="black"  face="times new roman" size=3><b>MNO</b></font></td>
					<td  width="5%" ><font color="black"  face="times new roman" size=3><b>ALT-MNO</b></font></td>  
        	...
        	%>
				...
				<td width="5%" align=left><font color="#666666"><b><%=rs.getString(8)%></td>
				<td width="5%" align=left><font color="#666666"><b><%=rs.getString(9)%></td>
				<td width="5%" align=left><font color="#666666"><b><%=rs.getString(10)%></td>
				<td width="5%" align=left><font color="#666666"><b><%=rs.getString(11)%></td>
...
var r=confirm("Do you want to Delete this Record Permanently");
	if(r==true)
	{
		...
		document.trl.action="delemp.jsp";
		document.trl.submit();
	}
	else
	{
