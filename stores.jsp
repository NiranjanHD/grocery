...
<div id="content_vertical">
  ...
  <table>
  <tr> <h1>Malleshwaram</h1>
  <td align="left"><p>
 
  </p></td>
 <p>
	   				Office no.2,first floor,paras<br>
	   				downtown center,golf course road,<br>
	   				sector 53,bangalore-570056(india)<br>
	   				<br>T.no : +91-9009008011 (or) 
	   Write us at www.ogc.com </p>
	   
  </tr>
  <tr>
  <td><div id="itemslist"></div></td>
  </tr>
  </table>
</div>
