...
<body>
<form name="adminadd" method="get" action="updetails.jsp">
  ...
  <li><a href="delivery.jsp">Reports</a></li>
...
<div id="content_01">
        ...
        <tr>
            <td><div id="content_01_image">
                      <div id="page_name">update success</div>
                </div>
...
<div id="content_vertical25">
 <table align="center" height="300px">
 	<tr>
		<td><h1>Item Successfully updated</h1></td>
	</tr>
